...
// }
// reverseList(['bulba','char','pika','butter'])
...
//     return a.reduce((acc, c) => acc + c **2, 0) > b.reduce((acc,c) => acc + c**3, 0)
    // a.reduce reduces to 12                    // b.reduce reduces to 24   
// }
...
// [68, -1, 1, -7, 10, 10] => [-1, 10]
// Filter metrhod / array method

                        // ****** FILTER *********
// function isMultiple(arr){
//     return arr.filter((e,i) => e % i === 0)
    // e = element i = index a = array 
    // filter grabs the element, index and array creating a NEW array
// }
...
//     return arr.reduce((acc, c) => acc + Number(c), 0)
// }
// console.log(sumOfVals(['5',3,'2',1]))

const s = r => r.reduce((a,c) =>+a+ +c) // Codewars type code
